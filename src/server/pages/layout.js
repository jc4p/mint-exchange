...
export const Layout = ({ children, title, frameMetadata }) => {
  // Default frame metadata
  const defaultFrameMetadata = {
    version: "next",
  ...
  const finalFrameMetadata = frameMetadata || defaultFrameMetadata
  ...
  return html`
    ...
    <head>
      ...
      <meta name="fc:frame" content='${JSON.stringify(finalFrameMetadata)}' />
